    ...
    class="absolute flex flex-col bg-slate-100 dark:text-slate-500 w-96 h-56 dark:bg-slate-800 font-bold shadow p-[6px] rounded-md text-slate-500 top-[50vh] left-1/2 -translate-x-1/2">
        <div class="flex flex-row justify-between">
            <div class="flex flex-row gap-1">
                <input bind:this={input} {value} class="dark:text-slate-500 dark:bg-slate-700 font-bold shadow p-[6px] rounded-md text-slate-500" type="password" />
                <button class="dark:text-slate-500 dark:bg-slate-700 font-bold shadow p-[6px] rounded-md text-slate-500"
                on:click={handleShow}
                >
            ...
            <button on:click={handleSetSource} class="dark:text-slate-500 dark:bg-slate-700 font-bold shadow p-[6px] rounded-md text-slate-500">set source</button>
        </div>
	</div>
{/if}